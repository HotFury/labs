...
namespace nk_lab_3
{
    ...
    partial class HebbNet : Log
    {
        ...
        public void InitNet(List<int[]> letters, ref System.Diagnostics.Stopwatch teachTime)
        {
        ...
        public int Recognize(int[] letter, ref System.Diagnostics.Stopwatch recTime)
        {
            recTime.Start();
            int res = -1;
